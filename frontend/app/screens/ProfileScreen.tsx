...
const styles = StyleSheet.create({
  ...
  avatarContainer: {
    ...
    borderRadius: 55,
    borderWidth: 3,
    borderColor: isDarkMode ? '#00cec9' : '#00b894',
    overflow: 'hidden',
  ...
  trackColor={{ false: '#ccc', true: '#00b894' }}
  thumbColor={isDarkMode ? '#00b894' : '#fff'}
/>
  ...
  >
    <Dialog.Icon icon="logout-variant" size={44} color={isDarkMode ? '#00cec9' : '#00b894'} />
    ...
    <Dialog.Actions style={{ justifyContent: 'space-evenly', paddingBottom: 12 }}>
      <Button
        ...
        textColor={isDarkMode ? '#00cec9' : '#00b894'}
        style={{
          borderColor: isDarkMode ? '#00cec9' : '#00b894',
          borderRadius: 10,
      ...
      <Button
        ...
        buttonColor={isDarkMode ? '#00cec9' : '#00b894'}
        textColor="#fff"
        style={{
          borderRadius: 10,
...
<Portal>
  ...
  >
    <Dialog.Icon icon="lock-reset" size={44} color={isDarkMode ? '#00cec9' : '#00b894'} />
...
<Portal>
  ...
  >
    <Dialog.Icon icon="check-circle" size={44} color={isDarkMode ? '#00cec9' : '#00b894'} />
